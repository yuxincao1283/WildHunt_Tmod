...
{
	public class UpperSlash_s2 : ModProjectile
	{
		...
		private float execTime => 35f / Owner.GetTotalAttackSpeed(Projectile.DamageType);		public override string Texture => "LimbusCompanyWildHunt/Content/Items/WildHunt"; // Use texture of item as projectile textureE
		...
		public override void OnSpawn(IEntitySource source) {
			...
			Helper.playSound("wildheath_2_3");
