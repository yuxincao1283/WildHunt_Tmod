...
{
	public class WildHuntS1_2 : ModProjectile
	{
        ...
        public override void SetDefaults() {
            ...
            projectileInfo[0] = new Helper.textureInfo(700, 700, new List<Texture2D>{normalTexture}, 0.8f);
            projectileInfo[1] = new Helper.textureInfo(1101, 590, Helper.loadVfxFolder("Pierce/", 369, 387), 2f);
		...
		public void ChargeStrike() {
			...
			armAngleOffset = MathHelper.SmoothStep(0, maxArmAngle, Timer/chargeTime);
